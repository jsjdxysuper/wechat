...
Page({
  ...
  onLoad: function (options) {
    var that = this;
    wx.request({
      url: getApp().globalData.REMOTE_URL + 'weixin/sysCode?typeid=sysset&id=trainAgencyPic',
      data: "OK",
      method: 'POST',
    ...
    wx.request({
      url: getApp().globalData.REMOTE_URL + 'weixin/sysCode?typeid=sysset&id=trainAgencyTitlePic',
      data: "OK",
      method: 'POST',
      success: function (res) {
        //console.log('submit success');
